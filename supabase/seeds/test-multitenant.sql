-- =====================================================
-- SEED: DATASET MULTI-TENANT DE PRUEBA
-- =====================================================
-- Genera un entorno con 2 clínicas independientes para testear RLS.

BEGIN;

-- 1. LIMPIEZA (Opcional - solo si se quiere un seed limpio)
...
-- 3. USUARIOS EN AUTH.USERS (Para desarrollo local)
...
-- 4. USUARIOS (PROFILES) - public.usuarios
...
-- 7. PACIENTES (Necesarios para crear turnos)
